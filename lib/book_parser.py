...
class BookParser(object):
    ...
    def _get_occurrences(self, book_html, word, entity_data):
        ...
        Returns:
            list: list of occurrence information for the word
        """
